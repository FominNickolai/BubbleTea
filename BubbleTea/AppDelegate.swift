...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    lazy var coreDataStack = CoreDataStack(modelName: "BubbleTea")
    ...
    func importJSONSeedData() {
        ...
        for jsonDictionary in jsonArray {
            ...
            let categoryDict = jsonDictionary["categories"] as! [[String: AnyObject]]
            let catName = categoryDict[0]["name"] as? String
            let catId = categoryDict[0]["id"] as? String
